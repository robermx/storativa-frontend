...
export const aboutLinks = [
  { id: 1, path: '/register', displayName: 'Crear mi Storativa', variant: variantType.contained, icon: ChevronRight },
  { id: 2, path: '/login', displayName: 'Iniciar sesión', variant: variantType.outlined, icon: null  },
]