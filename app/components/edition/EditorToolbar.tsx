...
const EditorToolbar = ({ editor }: EditorToolbarProps) => {
  ...
  return (
    <div
      ...
      className="sticky top-18 z-20 flex flex-wrap items-center gap-1 border-b border-dark/10 bg-lightness/95 p-2 backdrop-blur dark:border-light/10 dark:bg-darkness/95"
    >
      <select
